...
segundo = float(input("Digite qualquer valor de segundos: "))

minute = hours * 60
segundos = minute * 60
print(f"O resultado da expressao de hora eh: {minute} h")
print(f"O resultado da expressao de hora eh: {segundos} s")
